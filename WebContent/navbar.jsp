<nav class="navbar navbar-expand-lg navbar-dark primary-background">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a href="loginpage.jsp" class="nav-link" href="#"> <span class = "fa fa-user-circle"></span> Login </a>
      </li>
      
      <li class="nav-item">
        <a href="registerpage.jsp" class="nav-link" href="#"> <span class = "fa fa-user-plus"></span> Signup </a>
      </li>
